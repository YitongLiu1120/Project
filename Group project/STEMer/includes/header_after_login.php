		...
		<ul class="navbar-nav">
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu">
					...
					<a class="dropdown-item" href="index.php#section2">Excellent People</a>
				</div>
			</li> 
			<li class="nav-item">
				<a class="nav-link" href="Job_page.php?id='. $user_id . '" style="color: white;">Job</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="?????.php?id='. $user_id .'" style="color: white;">Applications</a>
			</li>   
		</ul>
...
$query = "SELECT logoPath FROM profile where profileID = '$profileID' ";		
