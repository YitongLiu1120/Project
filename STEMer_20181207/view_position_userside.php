    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                <a type="button" class="btn btn-primary" href="ApplyForJob.php?positionID='.$positionid.'">Apply</a>
            </div>
        </div>
    </div>
</div>
...
<ul class="list-group list-group-flush" style="list-style: none">
        <li class="list-group-item">
            ...
            <a type="button" class="btn btn-secondary" href="ApplyForJob.php?positionID='.$positionid.'" style="margin-top: 10px">Apply</a>
        </li>
    </ul>
</div>
';} else {
    echo '
        <p class="error">position has been accessed in error.</p><p><br /><br /></p>';
}
